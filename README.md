...
RepViewer 是一个面向东方 Project 录像文件（`.rpy`）的 Windows 查看器。当前版本为 **1.0.0.0**。
...
RepViewer is a Windows viewer for Touhou Project replay files (`.rpy`). The current version is **1.0.0.0**.
